...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_3x6_3(
    ...
    TO(STENO),  LGUI_T(KC_A),     LALT_T(KC_S), LCTL_T(KC_D),      LSFT_T(KC_F),    KC_G,                 KC_H,            RSFT_T(KC_J),     RCTL_T(KC_K),    LALT_T(KC_L),   RGUI_T(KC_QUOT),     U_NU,
  ...
  [BUTTON] = LAYOUT_3x6_3(
    ...
    _______,    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_TRNS, KC_TRNS, KC_RSFT, KC_RCTL, KC_LALT, KC_RGUI, U_NU,
  ...
  [NUM] = LAYOUT_3x6_3(
    ...
    _______,    KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  U_NA,    KC_RSFT, KC_RCTL, KC_LALT, KC_RGUI, U_NU,
  ...
  [SYM] = LAYOUT_3x6_3(
    ...
    _______,    KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, U_NA,    KC_RSFT, KC_RCTL, KC_LALT, KC_RGUI, U_NU,
  ...
  [FUN] = LAYOUT_3x6_3(
    ...
    _______,    KC_F11,  KC_F4,   KC_F5,   KC_F6,   U_SCRL,  U_NA,    KC_RSFT, KC_RCTL, KC_LALT, KC_RGUI, U_NU,
